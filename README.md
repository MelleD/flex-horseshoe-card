...
![build][build-badge]
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=MelleD_flex-horseshoe-card&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=MelleD_flex-horseshoe-card)
